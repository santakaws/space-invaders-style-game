...
# # TODO: set a ship_limit of 3
        ...
        self.pb_posn = (self.screen_width/2)-(self.button_width/2), (self.screen_height/2)-(self.button_height/2) + 220
        self.hsb_posn = (self.screen_width/2)-(self.button_width/2), (self.screen_height/2)-(self.button_height/2) + 320
